    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Domains Add</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="master_ip" value="<?php echo $this->input->post('master_ip'); ?>" class="form-control" id="master_ip" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="slave_ip" value="<?php echo $this->input->post('slave_ip'); ?>" class="form-control" id="slave_ip" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="url_check" class="form-control" id="url_check"><?php echo $this->input->post('url_check'); ?></textarea>
